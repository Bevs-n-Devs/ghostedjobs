...
func SearchCompany(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		http.Redirect(w, r, fmt.Sprintf("/reviews?companyNameError=%s%s", ERROR2, reviewsError), http.StatusSeeOther)
		return
	}
	...
	err = tmpl.Templates.ExecuteTemplate(w, "reviews.html", showCompanyReviews)
	if err != nil {
